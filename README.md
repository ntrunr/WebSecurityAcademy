...
## Web Cache Poisoning
- [x] Web cache poisoning with an unkeyed header (Practitioner) | [Youtube Video](https://yt.com)
- [x] Web cache poisoning with an unkeyed cookie (Practitioner) | [YouTube Video]()
